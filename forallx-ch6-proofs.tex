...
Amikor egy bizonyítást kezd, nézze meg a feltételeket; majd nézze meg az eddig kapott tételeket. Gondoljon ezeknek a tételeknek a fő műveleteire vonatkozó kiiktatási szabályokra. Ezek majd elárulják mik az opciói.
...
Egy rövid bizonyításnál, talán sikeresen kiiktathatja a feltételeket és előterjesztheti a következtetést. Formailag egy hosszú bizonyítás csak sok rövid bizonyítás összekapcsolva, tehát kitöltheti a rést azáltal, hogy felváltva dolgozik. Visszafelé a következtetéstől és előrefelé a feltételektől. 
...
Ha nem tud bebizonyítani valamit direkt módon, próbálja meg belátni az ellenkezőjét.
...
A legtöbb bizonyítás elvégezhető indirekt és direkt módon is. Az egyik talán könnyebb--- vagy esetleg az egyik jobban mozgatja a képzelő erejét mint a másik--- de mindkét módszer formálisan elfogadott.
...
\paragraph{Szükség szerint ismételjen.} Miután eldöntötte, hogyan juthat el a következtetésre, kérdezze meg, mit tehetne a feltételekkel. Ezután vegze fontolóra célként kitűzött tételeket, és nézze meg hogyan érheti el őket.
